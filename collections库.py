...
#除了key不存在时返回默认值，defaultdict的其他行为跟dict完全一样
...
d = dict([('a', 1), ('b', 2), ('c', 3)])
print('dict:',d)#dict的key是无序的
od = OrderedDict([('a', 1), ('b', 2), ('c', 3)])
print('OrderdDict :',od)#OrderedDict的key是有序的
#OrderedDict的key是按照插入的顺序排列，而不是key本身排序
